...
from routes.system_settings import router as system_router
from routes.services import router as service_router
from routes.orders import router as orders_router

app = FastAPI() #creamos una instancia de la fastAPI que estara en app 

load_dotenv() #cargamos las variables de entorno

logging.basicConfig(level=logging.INFO) #configuramos el nivel de logging que estara dando, en este caso de INFO para arriba
