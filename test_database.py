...
def test_connect():
    try:
        ...
        assert connection_result is True, "La conexion a la DB fallo"
...
def test_mongo_client():
    try:
        ...
        pytest.fail(f"Error en el llaado del cliente a MongoDb {str(e)}")    
...
def test_get_collection():
    try:
        ...
        pytest.fail(f"Error en obtener la coleccion de usuario {str(e)}")    
